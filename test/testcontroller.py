...
class TestController(unittest.TestCase):
    ...
    def test_find_best_startstations(self):
        ...
        self.assertEqual(result[0],
                         Stop(u'Bergheim Baggersee', u'48.32372', u'10.83283', stopid=u'2000005',
                              walkingtime=td(minutes=24), departuretime=dt(2016, 07, 14, 13, 35), isWalking=0))

        self.assertEqual(result[1],
                         Stop(u'Bergheim Baggersee', u'48.32372', u'10.83283', stopid=u'2000005',
                              walkingtime=td(minutes=24), departuretime=dt(2016, 07, 14, 13, 5), isWalking=0))

        self.assertEqual(result[2],
                         Stop(u'Bergheim Baggersee', u'48.32372', u'10.83283', stopid=u'2000005',
                              walkingtime=td(minutes=24), departuretime=dt(2016, 07, 14, 14, 5), isWalking=0))
        ...
        self.assertEqual(result[0],
                         Stop(u'Bergheim Baggersee', u'48.32372', u'10.83283', stopid=u'2000005',
                              walkingtime=td(minutes=12), departuretime=dt(2016, 07, 14, 13, 35), isWalking=0))

        self.assertEqual(result[1],
                         Stop(u'Bergheim Baggersee', u'48.32372', u'10.83283', stopid=u'2000005',
                              walkingtime=td(minutes=12), departuretime=dt(2016, 07, 14, 13, 5), isWalking=0))

        self.assertEqual(result[2],
                         Stop(u'Bergheim Baggersee', u'48.32372', u'10.83283', stopid=u'2000005',
                              walkingtime=td(minutes=12), departuretime=dt(2016, 07, 14, 14, 5), isWalking=0))
    ...
    def test_get_routes(self):
        ...
        self.assertEqual(routes[0].departure_time, dt(2016, 7, 14, 13, 00))
        ...
        self.assertEqual(routes[1].origin_stop.departuretime, dt(2016, 7, 14, 13, 30))
        ...
        self.assertEqual(routes[0].departure_time, dt(2016, 7, 14, 12, 32))
